...
func (b *BaseApi) Register(c *gin.Context) {
	...
	user := &system.SysUser{Username: r.Username,
		NickName: r.NickName, Password: r.Password,
		HeaderImg: r.HeaderImg, AuthorityId: r.AuthorityId,
		Authorities: authorities, Enable: r.Enable, Phone: r.Phone,
		Email: r.Email,
		BackendSetting: r.BackendSetting,
...
func (b *BaseApi) DeleteUser(c *gin.Context) {
	...
	//	return
	//}
	err = userService.DeleteUser(reqId)
	if err != nil {
