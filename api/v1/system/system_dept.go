...
var systemDeptService = service.ServiceGroupApp.SystemServiceGroup.SystemDeptService
...
// @accept application/json
// @Produce application/json
// @Param data body system.SystemDept true "删除SystemDept"
...
// @accept application/json
// @Produce application/json
// @Param data body system.SystemDept true "更新SystemDept"
...
// @accept application/json
// @Produce application/json
// @Param data query system.SystemDept true "用id查询SystemDept"
...
// @accept application/json
// @Produce application/json
// @Param data query systemReq.SystemDeptSearch true "分页获取SystemDept列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /systemDept/getSystemDeptList [get]
func (systemDeptApi *SystemDeptApi) GetSystemDeptList(c *gin.Context) {
	var pageInfo systemReq.SystemDeptSearch
