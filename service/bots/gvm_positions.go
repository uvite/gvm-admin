...
// Author [piexlmax](https://github.com/piexlmax)
func (gvmPositionsService *GvmPositionsService)GetGvmPositions(id uint) (gvmPositions bots.GvmPositions, err error) {
...
func (gvmPositionsService *GvmPositionsService)GetGvmPositionsInfoList(info botsReq.GvmPositionsSearch) (list []bots.GvmPositions, total int64, err error) {
	...
	err = db.Limit(limit).Offset(offset).Find(&gvmPositionss).Error
