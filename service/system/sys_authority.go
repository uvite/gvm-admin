...
// Author [piexlmax](https://github.com/piexlmax)
func (authorityService *AuthorityService) DeleteSystemRoleByIds(ids request.IdsReq) (err error) {
...
func (authorityService *AuthorityService) GetAuthorityInfoTree() (list interface{}, err error) {

	db := global.GVA_DB.Model(&system.SysAuthority{})

	var authority []system.SysAuthority
	err = db.Preload("DataAuthorityId").Find(&authority).Error
