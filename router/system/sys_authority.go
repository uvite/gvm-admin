...
func (s *AuthorityRouter) InitAuthorityRouter(Router *gin.RouterGroup) {
	...
	authorityApi := v1.ApiGroupApp.SystemApiGroup.AuthorityApi
	{
		...
		authorityRouter.DELETE("deleteAuthorityByIds", authorityApi.DeleteAuthoritys) // 删除角色
	...
	}
	{
		...
		authorityRouterWithoutRecord.GET("getAuthorityTree", authorityApi.GetAuthorityTree)  // 获取角色列表
	}
}
